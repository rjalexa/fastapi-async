...
class RedisTokenBucketRateLimiter:
    ...
    def __init__(self, redis_url: str = None, bucket_key: str = "openrouter:rate_limit:bucket"):
        """
    ...
    async def get_bucket_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "utilization_percent": (1 - current_tokens / capacity) * 100 if capacity > 0 else 0,
                "config": {
