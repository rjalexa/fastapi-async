...
class TestRedisTokenBucketRateLimiter:
    ...
    def mock_redis(self):
        ...
        mock = AsyncMock()
        mock.eval.return_value = [1, 10.0, 100.0, 1.0]  # Success, tokens, capacity, refill_rate
    ...
    @pytest.mark.asyncio
    async def test_bucket_status_with_refill_calculation(self, rate_limiter, mock_redis):
